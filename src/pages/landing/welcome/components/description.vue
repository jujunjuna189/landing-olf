...
<template>
    <div class="pt-28 pb-28 border-t-2 border-secondary">
        <div class="grid grid-cols-5">
            <div class=""></div>
            <div class="flex gap-10 leading-3 col-span-4 pr-24">
                <div class="border-t-2 border-secondary w-14 min-w-14 max-w-14 h-2 mt-8"></div>
                <div>
                    <span class="lowercase text-2xl font-medium">Since 2020, Ono Law Firm in Jakarta has been providing high-quality, personalized legal services to businesses and individuals, with a strong commitment to client relationships and successful outcomes.</span>
                    <div class="leading-6">
